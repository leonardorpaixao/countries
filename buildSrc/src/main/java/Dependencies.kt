...
object Dependencies {
    ...
    val ktorServerNetty = "io.ktor:ktor-server-netty:$ktor_version"
    val ktorClientCore = "io.ktor:ktor-client-core:$ktor_version"
    val ktorClientCoreJvm = "io.ktor:ktor-client-core-jvm:$ktor_version"
    val ktorJson = "io.ktor:ktor-client-json-jvm:$ktor_version"
    val ktorGson = "io.ktor:ktor-client-gson:$ktor_version"
    val ktorClientHttp = "io.ktor:ktor-client-okhttp:$ktor_version"
