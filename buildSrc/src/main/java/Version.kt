...
object Versioning {
    ...
    fun generateVersionName(): String {
        return "$major.$minor.$patch-$bump$qualifier"
    }
    ...
    @JvmStatic
    fun isProductionBuild() = getBuildId() != DEVELOPMENT

    enum class Qualifier {
        INTERNAL {
            override fun nameQualifier(): String = "-INTERNAL-$bump"
        },

        ALFA {
            override fun nameQualifier(): String = "-ALFA-$bump"
        },

        BETA {
            override fun nameQualifier(): String = "-BETA-$bump"
        },

        RC {
            override fun nameQualifier(): String = "-RC-$bump"
        },
